...
export const 科技配置 = {
    ...
    [科技ID.初始科技]: 定义研究({
        ...
        名称: '初始科技',
        解锁配方: 
            [配方ID.铁矿采集,配方ID.铜矿采集,配方ID.煤炭采集,配方ID.石头采集,配方ID.铁板冶炼,
    ...
    [科技ID.自动化]: 定义研究({
        id: 科技ID.自动化,
        名称: '自动化',
        投入: [[物品ID.铁板, 50],[物品ID.齿轮,5],[物品ID.蒸汽机,5]], // 每次投入
        耗时: 50,
        解锁配方: [配方ID.组装机制造,],
        前置科技: [科技ID.蒸汽]
    }),
