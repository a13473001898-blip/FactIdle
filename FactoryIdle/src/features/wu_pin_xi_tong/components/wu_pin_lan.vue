    ...
    <div style="display: flex; flex-direction: column; gap: 16px;">
        ...
        <n-collapse :default-expanded-names="['高级筛选']">
            <n-collapse-item title="筛选与追踪" name="高级筛选">
                <div  style="background-color: v-bind('themeVars.actionColor'); padding: 16px; border-radius: 8px; border: v-bind('themeVars.borderColor');">
...
// 引入 获取物品数据 用于查询缺失的类型
import { 物品类型, 获取所有物品列表, 物品ID, 获取所有配方列表, 获取物品数据 } from '@/shared/pei_zhi_shu_ju';
